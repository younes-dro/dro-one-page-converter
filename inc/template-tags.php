...
if ( ! function_exists( 'dro_one_page_converter_posted_on' ) ) :
	...
	function dro_one_page_converter_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'dro-one-page-converter' ),
...
if ( ! function_exists( 'dro_one_page_converter_posted_by' ) ) :
	...
	function dro_one_page_converter_posted_by() {
		$byline = sprintf(
			...
			esc_html_x( 'by %s', 'post author', 'dro-one-page-converter' ),
			...
			comments_popup_link(
				sprintf(
					wp_kses(
						...
						__( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'dro-one-page-converter' ),
						array(
							'span' => array(
								'class' => array(),
							),
		...
		edit_post_link(
			sprintf(
				wp_kses(
					...
					__( 'Edit <span class="screen-reader-text">%s</span>', 'dro-one-page-converter' ),
					array(
						'span' => array(
							'class' => array(),
						),
